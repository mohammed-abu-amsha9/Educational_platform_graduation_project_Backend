...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('student_exam_answers', function (Blueprint $table) {
            $table->id();
            $table->foreignId('student_id')->constrained()->onDelete('cascade'); // يرتبط بالطالب الفرد الذي يقوم بتقديم الإجابة حالياً
            $table->foreignId('exam_id')->constrained()->onDelete('cascade'); // رقم الامتحان الإجمالي المحلول داخله السؤال

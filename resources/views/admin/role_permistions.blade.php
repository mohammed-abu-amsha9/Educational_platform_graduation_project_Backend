                    ...
                    <div
                        ...
                        <form class="space-y-4" onsubmit="event.preventDefault()">
                            <div>
                                ...
                                <input type="text" placeholder="مثال: معلم لغة عربية"
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <label class="flex items-center justify-between"><span
                                            class="text-gray-600 dark:text-zinc-300">تسجيل الحضور</span><input
                                            type="checkbox" class="accent-blue-600" /></label>
                                    <label class="flex items-center justify-between"><span
                                            class="text-gray-600 dark:text-zinc-300">رفع ملفات</span><input type="checkbox"
                                            class="accent-blue-600" /></label>
                                    <label class="flex items-center justify-between"><span
                                            class="text-gray-600 dark:text-zinc-300">إنشاء اختبارات</span><input
                                            type="checkbox" class="accent-blue-600" /></label>
                                    <label class="flex items-center justify-between"><span
                                            class="text-gray-600 dark:text-zinc-300">تعديل الدرجات</span><input
                                            type="checkbox" class="accent-blue-600" /></label>
                                    <label class="flex items-center justify-between"><span
                                            class="text-gray-600 dark:text-zinc-300">الرد على رسائل
                                            الطلاب</span><input type="checkbox" class="accent-blue-600" /></label>
                                    <label class="flex items-center justify-between"><span
                                            class="text-gray-600 dark:text-zinc-300">تعديل درجات مواد
                                            أخرى</span><input type="checkbox" class="accent-blue-600" /></label>
                                </div>
                            </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="w-full">
                                ...
                                <div class="flex items-center gap-2 mt-1 text-xs text-gray-400">
                                    <span><i class="fa-solid fa-user text-teal-500/80 ml-1"></i>
                                        المرتبط: سارة الدهان</span>
                                </div>
                            ...
                            <form class="p-6 space-y-5 overflow-y-auto flex-1 max-h-[calc(100vh-16rem)]" id="editRoleForm"
                                ...
                                <div>
                                    <label class="block text-[11px] font-bold text-gray-500 dark:text-slate-400 mb-1.5">اسم
                                        الدور</label>
                                    <input type="text" value="معلم لغة عربية"
                                ...
                                <div>
                                    <label
                                        class="block text-[11px] font-bold text-gray-500 dark:text-slate-400 mb-1.5">المعلم
                                        المرتبط</label>
                                    <select
                                        class="w-full border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-950 text-slate-800 dark:text-zinc-100 rounded-xl py-2.5 px-4 text-xs outline-none focus:border-teal-500 cursor-pointer">
                                        <option value="1">سارة الدهان</option>
                                        <option value="2">خالد النجار</option>
                                    </select>
                                </div>

                                <div>
                                    <label
                                        class="block text-[11px] font-bold text-gray-500 dark:text-slate-400 mb-2.5 uppercase tracking-wider">تعديل
                                        الصلاحيات الممنوحة</label>
                                    <div
                                        ...
                                        <label class="flex items-center justify-between py-1 cursor-pointer group">
                                            <span
                                                class="text-slate-700 dark:text-zinc-300 group-hover:text-teal-600 dark:group-hover:text-white transition-colors">رفع
                                                ملفات المادة</span>
                                        ...
                                        <label class="flex items-center justify-between py-1 cursor-pointer group">
                                            <span
                                                class="text-slate-700 dark:text-zinc-300 group-hover:text-teal-600 dark:group-hover:text-white transition-colors">الرد
                                                على الرسائل</span>
                                            <input type="checkbox" checked
                                                class="w-4 h-4 accent-teal-500 cursor-pointer" />
                                        </label>
                                        ...
                                        <label class="flex items-center justify-between py-1 cursor-pointer group">
                                            <span
                                                class="text-slate-700 dark:text-zinc-300 group-hover:text-teal-600 dark:group-hover:text-white transition-colors">تسجيل
                                                الحضور والغياب</span>
                                            <input type="checkbox" checked
                                                class="w-4 h-4 accent-teal-500 cursor-pointer" />
                                        </label>
                                        ...
                                        <label class="flex items-center justify-between py-1 cursor-pointer group">
                                            <span
                                                class="text-slate-700 dark:text-zinc-300 group-hover:text-teal-600 dark:group-hover:text-white transition-colors">إدارة
                                                الاختبارات</span>
                                            <input type="checkbox" checked
                                                class="w-4 h-4 accent-teal-500 cursor-pointer" />
                                        </label>

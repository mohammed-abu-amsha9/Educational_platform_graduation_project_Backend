...
<body class="bg-gray-50 text-gray-850 dark:bg-slate-950 dark:text-zinc-100">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div
            ...
            {{ request()->routeIs('dashboardTeacher.index') ? 'bg-teal-700 text-white font-bold shadow-md shadow-teal-700/10' : 'dark:text-zinc-100 text-gray-600 font-semibold hover:text-teal-700' }}">
                    <i
                        class="fa-solid fa-gauge-high text-base {{ request()->routeIs('dashboardTeacher.index') ? 'text-zinc-100' : '' }}"></i>
            ...
            {{ request()->routeIs('attendance.index') ? 'bg-teal-700 text-white font-bold shadow-md shadow-teal-700/10' : 'dark:text-zinc-100 text-gray-600 font-semibold hover:text-teal-700' }}">
                ...
                <a href="{{ route('questions.index') }}"
                    class="flex items-center justify-center sm:justify-start gap-1.5 px-4 py-3 rounded-xl text-sm whitespace-nowrap
            {{ request()->routeIs('questions.index') ? 'bg-teal-700 text-white font-bold shadow-md shadow-teal-700/10' : 'dark:text-zinc-100 text-gray-600 font-semibold hover:text-teal-700' }}">
                ...
                <a href="{{ route('exams.index') }}"
                    class="flex items-center justify-center sm:justify-start gap-1.5 px-4 py-3 rounded-xl text-sm whitespace-nowrap
            {{ request()->routeIs('exams.index') ? 'bg-teal-700 text-white font-bold shadow-md shadow-teal-700/10' : 'dark:text-zinc-100 text-gray-600 font-semibold hover:text-teal-700' }}">
                    <i class="fa-solid fa-file-pen text-base"></i>
                    <span>مولد الإختبارات</span>
                </a>
                <a href="{{ route('exams.create') }}"
                    class="flex items-center justify-center sm:justify-start gap-1.5 px-4 py-3 rounded-xl text-sm whitespace-nowrap
            {{ request()->routeIs('exams.create') ? 'bg-teal-700 text-white font-bold shadow-md shadow-teal-700/10' : 'dark:text-zinc-100 text-gray-600 font-semibold hover:text-teal-700' }}">
                    <i class="fa-solid fa-file-pen text-base"></i>
